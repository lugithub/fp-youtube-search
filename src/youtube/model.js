...
const Video = daggy.tagged('Video', ['id', 'thumbnail', 'url', 'title']);
...
const makeUrl = (term) =>
  `https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=24&type=video&q=${term}&key=AIzaSyDoBHAuHjjKeANT_T5WV8XIjrYpAo3BiOU`; // xxxx is the Google API key
